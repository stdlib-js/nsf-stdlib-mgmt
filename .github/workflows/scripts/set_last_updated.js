...
var FIELD_MUTATION = `mutation( $project:ID!, $field:ID!, $item:ID!, $date:Date! ) {
...
/**
* Updates the "Last Updated" project column for the current issue.
*
* @private
...
*/
async function main( github, context, core, projectName ) {
	var variables;
	var project;
	var result;
	var owner;
	...
	if ( context.eventName === 'issues' ) {
		date = context.payload.issue.updated_at;
	} else {
		date = context.payload.comment.updated_at;
	}
	variables = {
		'project': project.id,
		'field': field.id,
